      ...
      <footer className=" shrink-0 bg-black">
        <div className=" container p-8 text-white">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-3">
            <div className="flex w-[200px] justify-center rounded-md bg-white p-3 ">
              <img src="/herologo.svg" alt="AI Days 2024 Logo" className="" />
            </div>
            <div>
            ...
            <div>
              ...
              <address className="mt-2 not-italic">
                ...
                <br />
                Ashok Nagar, Kukatpally Housing Board Colony,
                <br />
        ...
        <div className="mt-6 bg-slate-900 p-3 text-center text-xl text-white">
          ©2024 AI Days | Powered by AI Days
        </div>
      </footer>
    </>
  );
